...
// PROJECT 03: filebacker function
extern int filebacker(struct proc *p);
...
usertrap(void)
{
  ...
  if(r_scause() == 8){
    ...
    // PROJECT 03: file-backed operation
    if(filebacker(p)<0){
      panic("Error in file backing.");
    }
  } else {
...
clockintr()
{
  ...
  // of a second.
  // TODO: fix from 1000,000 cycles to 100000 cycles in project 02
